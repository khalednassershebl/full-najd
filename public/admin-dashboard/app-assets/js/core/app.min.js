  ...
  (function (a, e, t) {
    ...
    if (
      ...
      var l = e.querySelector(".drag-target"),
        c = "panright",
        d = "panleft";
      if ((!0 === i && ((c = "panleft"), (d = "panright")), t(l).length > 0))
        ...
        if (
          ...
          if (
            ...
            x.addClass("show-overlay"),
              ...
              !1 === n && (w.addClass("show"), S.removeClass("show"));
            var o = "",
              i = "",
              l = "",
              c = "",
            ...
            t.getJSON(r + "data/" + p + ".json", function (a) {
              for (var m = 0; m < a.listItems.length; m++) {
                if (
                  ...
                  for (
                    ...
                    if (
                      a.listItems[m].name ===
                      p[v].firstChild.dataset.originalTitle
                    ) {
                      s = " text-warning";
                      break;
                    }
              ...
              (u = t(".main-search-list-defaultlist").html()),
                "" == o &&
                  "" == i &&
                  (i = t(".main-search-list-defaultlist-other-list").html()),
                (l = d.concat(o, i, u)),
