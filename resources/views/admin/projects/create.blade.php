...
@section('title', 'إضافة مشروع | لوحة الإدارة')
@section('page-title', 'إضافة مشروع')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 mb-1">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required placeholder="عنوان المشروع">
                        ...
                        <div class="col-12 mb-1">
                            ...
                            <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" placeholder="يظهر تحت التصنيف في البطاقة">
                            @error('subtitle')<span class="text-danger small">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-12 mb-1">
                            <label class="form-label" for="excerpt">المقتطف</label>
                            <textarea class="form-control" id="excerpt" name="excerpt" rows="2" placeholder="نبذة قصيرة">{{ old('excerpt') }}</textarea>
