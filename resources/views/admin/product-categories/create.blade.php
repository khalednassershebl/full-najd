...
@section('title', 'إضافة تصنيف منتجات | لوحة الإدارة')
@section('page-title', 'إضافة تصنيف منتجات')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required placeholder="مثال: القطاع الطبي">
                            @error('name')<span class="text-danger small">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-md-4 mb-1">
                            <label class="form-label" for="slug">الرابط (Slug)</label>
                            <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug') }}" placeholder="يُولد تلقائياً (يُستخدم للتصفية في الصفحة)">
