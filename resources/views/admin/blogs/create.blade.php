...
@section('title', 'إضافة مقالة | لوحة الإدارة')
@section('page-title', 'إضافة مقالة')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 mb-1">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required placeholder="عنوان المقالة">
                        ...
                        <div class="col-12 mb-1">
                            ...
                            <textarea class="form-control" id="excerpt" name="excerpt" rows="2" placeholder="نبذة قصيرة تظهر في قائمة المقالات">{{ old('excerpt') }}</textarea>
