...
@section('title', 'تعديل الشريك | لوحة الإدارة')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $partner->name) }}" required placeholder="اسم الشريك">
                        ...
                        <div class="col-md-6 mb-1">
                            ...
                            <div class="d-flex flex-wrap align-items-start gap-2">
                                @php
                                    $imageUrl = $partner->image ? asset('storage/' . $partner->image) : '';
                                @endphp
