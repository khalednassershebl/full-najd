...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ajax: assetPath + "data/exams-data.json",
      columns: [
        { data: "id" }, // 0
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 7,
          render: function (data, type, full, meta) {
            var $status_number = full["exam_status"];
            var $status = {
              1: { title: "جديد", class: "status-new" },
              2: { title: "مفتوح", class: "status-active" },
              3: { title: "مٌنتهى", class: "status-ban" },
            };
